  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      ...
      if(!warnmember && args[0] && args[0].length == 18) {
        ...
        if(!warnmember || warnmember == null || !warnmember.id) return message.reply("<833101993668771842> I failed finding that User...")
      ...
      if (!warnmember)
        return message.channel.send(new MessageEmbed()
          ...
          .setTitle(`<833101993668771842> Please add a Member you want to see the warnings of!`)
      ...
      try {
        ...
        if (!warnIDs || !warnData || !warnIDs.length)
          return message.channel.send(new MessageEmbed()
            ...
            .setTitle(`<833101993668771842> \`${warnmember.username}\` has no Global-Warnings`)
          );
