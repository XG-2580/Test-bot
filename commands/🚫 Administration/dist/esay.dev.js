      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            cmdroles = client.settings.get(message.guild.id, "cmdadminroles.esay");
            cmdrole = [];
          ...
          case 29:
            ...
            message.channel.send({
              embed: new MessageEmbed().setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setFooter(es.footertext, es.footericon).setDescription(text.substr(0, 2048))
            });
