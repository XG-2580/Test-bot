      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            cmdroles = client.settings.get(message.guild.id, "cmdadminroles.removerole");
            cmdrole = [];
          ...
          case 29:
            ...
            return _context.abrupt("return", message.channel.send(new MessageEmbed().setColor(es.wrongcolor).setFooter(es.footertext, es.footericon).setTitle("please ping a USER!").setDescription(" Usage: `".concat(prefix, "removerole @USER @ROLE`"))));
          ...
          case 32:
            ...
            return _context.abrupt("return", message.channel.send(new MessageEmbed().setColor(es.wrongcolor).setFooter(es.footertext, es.footericon).setTitle("please ping a ROLE!").setDescription(" Usage: `".concat(prefix, "removerole @USER @ROLE`"))));
          ...
          case 35:
            ...
            return _context.abrupt("return", message.channel.send(new MessageEmbed().setColor(es.wrongcolor).setFooter(es.footertext, es.footericon).setTitle("I cannot remove that Role from this Member, because he is higher/Equal to your Rang Position!")));
          ...
          case 37:
            ...
            return _context.abrupt("return", message.channel.send(new MessageEmbed().setColor(es.wrongcolor).setFooter(es.footertext, es.footericon).setTitle("I cannot remove that Role from this Member, because it's higher then your highest ROLE!")));
          ...
          case 39:
            ...
            return _context.abrupt("return", message.channel.send(new MessageEmbed().setColor(es.wrongcolor).setFooter(es.footertext, es.footericon).setTitle("I cannot remove that Role from this Member, because he doesn't have it!")));

          case 41:
            ge = false;
            member.roles.remove(role.id)["catch"](function (e) {
              console.log(e);
              ge = e;
            });
            ...
            return _context.abrupt("return", message.channel.send(new MessageEmbed().setColor(es.wrongcolor).setFooter(es.footertext, es.footericon).setTitle("Something went wrong").setDescription(ge.message)));

          case 45:
            message.channel.send(new MessageEmbed().setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setFooter(es.footertext, es.footericon).setTitle("removed `".concat(role.name, "` from `").concat(member.user.tag, "`")));
