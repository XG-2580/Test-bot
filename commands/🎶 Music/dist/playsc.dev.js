    ...
    return regeneratorRuntime.async(function run$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            message.channel.send(new MessageEmbed().setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setTitle("**Searching**").setDescription("```".concat(text, "```"))).then(function (msg) {
              msg["delete"]({
                timeout: 5000
              })["catch"](function (e) {
