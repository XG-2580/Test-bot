      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            return _context.abrupt("return", message.channel.send(new MessageEmbed().setTitle("".concat(player.get("autoplay") ? "".concat(emoji.msg.enabled, " Enabled") : "".concat(emoji.msg.disabled, " Disabled"), " Autoplay")).setDescription("To ".concat(player.get("autoplay") ? "disable" : "enable", " it type: `").concat(prefix, "autoplay`")).setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setFooter(es.footertext, es.footericon)));
