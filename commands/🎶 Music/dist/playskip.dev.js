    ...
    return regeneratorRuntime.async(function run$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            message.channel.send(new MessageEmbed().setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setTitle("**Searching** \uD83D\uDD0E & **Skipping** ".concat(emoji.msg.skip_track)).setDescription("```".concat(text, "```"))).then(function (msg) {
              msg["delete"]({
                timeout: 5000
              })["catch"](function (e) {
