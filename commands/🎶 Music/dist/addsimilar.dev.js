    ...
    return regeneratorRuntime.async(function run$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            _context.prev = 3;
            playermanager(client, message, Array("https://www.youtube.com/watch?v=".concat(player.queue.current.identifier, "&list=RD").concat(player.queue.current.identifier)), "similar:add");
            _context.next = 11;
            break;
