        ...
        switch (_context.prev = _context.next) {
          ...
          case 10:
            fetch("https://discord.com/api/v8/channels/".concat(channel.id, "/invites"), {
              ...
              if (!invite.code) {
                return message.channel.send(new MessageEmbed().setDescription("Cannot start the chess, please retry").setColor(es.wrongcolor).setFooter(es.footertext, es.footericon));
              }
