      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 12:
            ...
            return _context.abrupt("return", message.channel.send(new MessageEmbed().setColor(es.wrongcolor).setFooter(es.footertext, es.footericon).setTitle("This Role is alerady in the List!")));
          ...
          case 14:
            ...
            return _context.abrupt("return", message.channel.send(new MessageEmbed().setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setFooter(es.footertext, es.footericon).setTitle("Added the DJ ROLE `".concat(role.name, "`")).setDescription("All Dj Roles:\n> ".concat(leftb.substr(0, leftb.length - 3)))));
