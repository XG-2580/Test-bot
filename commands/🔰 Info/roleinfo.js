  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {   
      ...
      if(args[0]){
        ...
        return message.reply("<833101993668771842> Please retry but add a Role/Rolename/Roleid");
      }
      if(!role || role == null || role.id == null || !role.id) message.reply("<833101993668771842> Could not find the ROLE")
        //create the EMBED
