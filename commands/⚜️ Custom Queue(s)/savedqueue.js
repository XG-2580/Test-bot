    ...
    try {
      ...
      if (!Type)
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<833101993668771842> You didn't entered a TYPE`)
        ...
        case `create`: {
          if (!Name)
            return message.channel.send(new MessageEmbed()
              .setColor(es.wrongcolor)
              .setFooter(es.footertext, es.footericon)
              .setTitle(`<833101993668771842> You didn't entered a Saved-Queue-Name`)
          ...
          if (Name.length > 10)
            return message.channel.send(new MessageEmbed()
              ...
              .setTitle(`<833101993668771842> Your Saved-Queue-Name is too long!`)
          ...
          if (client.queuesaves.get(message.author.id, `${Name}`))
            return message.channel.send(new MessageEmbed()
              .setFooter(es.footertext, es.footericon)
              .setColor(es.wrongcolor)
              .setTitle(`<833101993668771842> Your Queue already exists!`)
          ...
          return message.channel.send(new MessageEmbed()
            .setTitle(`<a833101995723194437> Created ${Name}`)
      ...
      case `addcurrenttrack`: {
        ...
        if (!client.queuesaves.get(message.author.id, `${Name}`))
          return message.channel.send(new MessageEmbed()
            .setFooter(es.footertext, es.footericon)
            .setColor(es.wrongcolor)
            .setTitle(`<833101993668771842> Your Queue does not exists yet!`)
        ...
        //return susccess message
        return message.channel.send(new MessageEmbed()
          .setTitle(`<a833101995723194437> Added ${track.title} onto the Queue \`${Name}\``.substr(0, 256))
      ...
      case `addcurrentqueue`: {
        ...
        if (!tracks.length)
          return message.channel.send(new MessageEmbed()
            .setFooter(es.footertext, es.footericon)
            .setColor(es.wrongcolor)
            .setTitle(`<833101993668771842> The Queue is Empty!`)
          );
        ...
        //return susccess message
        return message.channel.send(new MessageEmbed()
          .setTitle(`<a833101995723194437> Added ${tracks.length} Tracks onto the Queue \`${Name}\``)
      ...
      case `removesong`: {
        ...
        if (!Options)
          return message.channel.send(new MessageEmbed()
            .setColor(es.wrongcolor)
            .setFooter(es.footertext, es.footericon)
            .setTitle(`<833101993668771842> You didn't entered an Option (the Track you want to remove (ID OF IT))`)
        ...
        if (!client.queuesaves.get(message.author.id, `${Name}`))
          return message.channel.send(new MessageEmbed()
            .setFooter(es.footertext, es.footericon)
            .setColor(es.wrongcolor)
            .setTitle(`<833101993668771842> Your Queue is not existing!`)
            .setDescription(`Create it with: \`${prefix}savedqueue create ${Name}\``)
          );
        ...
        if (Number(Options) >= tracks.length || Number(Options) < 0)
          return message.channel.send(new MessageEmbed()
            .setColor(es.wrongcolor)
            .setFooter(es.footertext, es.footericon)
            .setTitle(`<833101993668771842> Your provided Option is out of Range (\`0\` - \`${tracks.length-1}\`)`)
            .setDescription(`See all your Tracks: \`${prefix}savedqueue showdetails ${Name}\`Usage: \`${prefix}savedqueue removetrack ${Name} <Song number>\``)
          )
        ...
        //return susccess message
        return message.channel.send(new MessageEmbed()
          .setTitle(`<a833101995723194437> Deleted ${deletetrack.title} of the Queue \`${Name}\``.substr(0, 256))
          .setDescription(`There are now: \`${client.queuesaves.get(message.author.id, `${Name}`).length} Tracks\`\n\nPlay it with: \`${prefix}savedqueue play ${Name}\``)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setFooter(es.footertext, es.footericon)
        );
      ...
      case `mix`: {
        ...
        if (!Array.isArray(oldtracks))
          return message.channel.send(new MessageEmbed()
            .setFooter(es.footertext, es.footericon)
            .setColor(es.wrongcolor)
            .setTitle(`<833101993668771842> Your Saved-Queue ${Name} is Empty!`)
            .setDescription(`Add the current **Queue** onto it: \`${prefix}savedqueue addcurrentqueue ${Name}\`\nAdd the current **Track** onto it: \`${prefix}savedqueue addcurrenttrack ${Name}\``)
          );
        ...
        //return susccess message
        return message.channel.send(new MessageEmbed()
          .setTitle(`<a833101995723194437> Shuffled ${newtracks.length} Tracks of the Queue \`${Name}\``.substr(0, 256))
          .setDescription(`There are now: \`${client.queuesaves.get(message.author.id, `${Name}`).length} Tracks\`\n\nPlay it with: \`${prefix}savedqueue play ${Name}\``)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setFooter(es.footertext, es.footericon))
      }
      ...
      case `removeduplicates`: {
        ...
        //return susccess message
        return message.channel.send(new MessageEmbed()
          .setTitle(`<a833101995723194437> Removed ${counter} Tracks from the Queue \`${Name}\``.substr(0, 256))
          .setDescription(`There are now: \`${client.queuesaves.get(message.author.id, `${Name}`).length} Tracks\`\n\nPlay it with: \`${prefix}savedqueue play ${Name}\``)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setFooter(es.footertext, es.footericon))
      }
      ...
      case `list`: {
        ...
        if (Object.size(queues) <= 1)
          return message.channel.send(new MessageEmbed()
            .setColor(es.wrongcolor)
            .setFooter(es.footertext, es.footericon)
            .setTitle(`<833101993668771842> You don't have any Queues saved yet`)
      ...
      case `save`: {
        ...
        //return susccess message
        return message.channel.send(new MessageEmbed()
          .setTitle(`<a833101995723194437> Created ${Name} and Added ${tracks.length} Tracks to it`)
      ...
      case `del`: {
        ...
        //return susccess message
        return message.channel.send(new MessageEmbed()
          .setTitle(`<a833101995723194437> Deleted the Queue \`${Name}\``)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setFooter(es.footertext, es.footericon)
        )
      }
      ...
      case `paly`: {
        ...
        tempmsg.edit(new MessageEmbed()
          .setTitle(`<a833101995723194437> Loaded ${client.queuesaves.get(message.author.id, `${Name}`).length} Tracks onto the current Queue`)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setFooter(es.footertext, es.footericon)
        )
      ...
      default:
        return message.channel.send(new MessageEmbed()
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
          .setTitle(`<833101993668771842> You didn't entered a **valid** TYPE`)
          .setDescription(`Usage: \`${prefix}savedqueue <Type> <Name>\`\nValid Types:\n\`create\`, \`addcurrenttrack\`, \`addcurrentqueue\`, \`removetrack\`, \`removedupes\`, \`showall\`, \`createsave\`, \`delete\`, \`showdetails\`, \`play\`, \`shuffle\``)
        );
        break;
