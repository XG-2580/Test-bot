    ...
    try {
      ...
      await tempmsg.channel.awaitMessages(m=>m.author.id == message.author.id, {
        ...
        .then(async collected => {
          ...
          if(channel){
            ...
            return message.reply(new Discord.MessageEmbed()
              .setTitle(`The Channel: \`${channel.name}\` is now registered as the Number-Counter-Chat`)
              .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
      ...
      if (timeouterror)
        return message.reply(new Discord.MessageEmbed()
          ...
          return message.reply(new Discord.MessageEmbed()
            .setTitle(`Disabled the Number-Counter-Chat`)
            .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          ...
          return message.reply(new Discord.MessageEmbed()
            .setTitle(`Resetted the Number to 0`)
            .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(`Settings of the Number-Counter-Chat`)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
