      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 15:
            ...
            return _context2.abrupt("return", message.reply(new Discord.MessageEmbed().setTitle("Missing Permission to add Reactions").setColor(es.wrongcolor).setDescription("```".concat(String(_context2.t0.message ? _context2.t0.message : _context2.t0).substr(0, 2000), "```").substr(0, 2000)).setFooter(es.footertext, es.footericon)));
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 3:
                      ...
                      return _context.abrupt("return", message.reply(new Discord.MessageEmbed().setTitle("The Channel: `".concat(channel.name, "` is now registered as the Ai-Chat")).setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setDescription("Posting now, every Minute".substr(0, 2048)).setFooter(es.footertext, es.footericon)));
          ...
          case 32:
            ...
            return _context2.abrupt("return", message.reply(new Discord.MessageEmbed().setTitle("Disabled the Ai-Chat").setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setDescription("I will not send automatic NSFW Images to a Channel anymore".substr(0, 2048)).setFooter(es.footertext, es.footericon)));
          ...
          case 37:
            ...
            return _context2.abrupt("return", message.reply(new Discord.MessageEmbed().setTitle("\uD83D\uDCD1 Settings of the Ai-Chat").setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setDescription("**Channel:** ".concat(thesettings == "no" ? "Not Setupped" : "<#".concat(thesettings, "> | `").concat(thesettings, "`")).substr(0, 2048)).setFooter(es.footertext, es.footericon)));

          case 42:
            return _context2.abrupt("return", message.reply(new Discord.MessageEmbed().setTitle("PLEASE CONTACT `XG#2846`").setColor(es.wrongcolor).setFooter(es.footertext, es.footericon)));
          ...
          case 45:
            ...
            return _context2.abrupt("return", message.channel.send(new MessageEmbed().setColor(es.wrongcolor).setFooter(es.footertext, es.footericon).setTitle("Something went Wrong").setDescription("```".concat(String(_context2.t1.message ? _context2.t1.message : _context2.t1).substr(0, 2000), "```"))));
