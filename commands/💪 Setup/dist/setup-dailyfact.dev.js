      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
                ...
                while (1) {
                  switch (_context.prev = _context.next) {
                    ...
                    case 3:
                      ...
                      return _context.abrupt("return", message.reply(new Discord.MessageEmbed().setTitle("The Channel: `".concat(channel.name, "` is now registered as the Daily Fact Poster Channel")).setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setDescription("Posting now, every Day".substr(0, 2048)).setFooter(es.footertext, es.footericon)));
          ...
          case 32:
            ...
            return _context2.abrupt("return", message.reply(new Discord.MessageEmbed().setTitle("Disabled the Daily Fact Poster Channel").setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setDescription("I will not send automatic Facts to a Channel anymore".substr(0, 2048)).setFooter(es.footertext, es.footericon)));
          ...
          case 37:
            ...
            thesettings = client.settings.get(message.guild.id, "dailyfact");
            return _context2.abrupt("return", message.reply(new Discord.MessageEmbed().setTitle("Settings of the Daily Fact Poster Channel").setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setDescription("**Channel:** ".concat(thesettings == "no" ? "Not Setupped" : "<#".concat(thesettings, "> | `").concat(thesettings, "`"), "\n\n**Cooldown:** 24 Hours").substr(0, 2048)).setFooter(es.footertext, es.footericon)));
