        ...
        switch (_context6.prev = _context6.next) {
          ...
          case 23:
            ...
            return regeneratorRuntime.awrap(tempmsg.edit({
              embed: new Discord.MessageEmbed().setTitle("In which Channel should I post all tiktok Videos?").setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setDescription("Please just ping the Channel with #channel!").setFooter(es.footertext, es.footericon)
            }));
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      client.social_log.set(message.guild.id, msg.mentions.channels.filter(function (ch) {
                        return ch.guild.id == msg.guild.id;
                      }).first().id, "tiktok.dc_channel");
                      return _context.abrupt("return", message.reply(new Discord.MessageEmbed().setTitle("I will now send all tiktok Notifications in `".concat(msg.mentions.channels.filter(function (ch) {
                        return ch.guild.id == msg.guild.id;
                      }).first().name, "`")).setDescription("DONT FORGET TO ADD A **tiktok_CHANNELS**!!!").setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setFooter(es.footertext, es.footericon)));
          ...
          case 33:
            ...
            return _context6.abrupt("return", message.reply(new Discord.MessageEmbed().setTitle("ERROR | You've reached the maximum amount of tiktok Channels").setColor(es.wrongcolor).setDescription("Remove some others first...".substr(0, 2000)).setFooter(es.footertext, es.footericon)));

          case 36:
            _context6.next = 38;
            return regeneratorRuntime.awrap(tempmsg.edit({
              embed: new Discord.MessageEmbed().setTitle("Which Channel do you wanna add? | Just send the LINK!").setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setDescription("Example:\n          \nhttps://www.tiktok.com/@milratodev").setFooter(es.footertext, es.footericon)
            }));
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 4:
                      ...
                      return _context2.abrupt("return", message.reply(new Discord.MessageEmbed().setTitle("ERROR | The tiktok Channel is already setup!").setColor(es.wrongcolor).setFooter(es.footertext, es.footericon)));

                    case 8:
                      client.social_log.push(message.guild.id, Channel, "tiktok.channels");
                      return _context2.abrupt("return", message.reply(new Discord.MessageEmbed().setTitle("added the Channel ".concat(Channel)).setDescription("You can change the default message via the **\"edit\"**").setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setFooter(es.footertext, es.footericon)));
          ...
          case 45:
            ...
            return _context6.abrupt("return", message.reply(new Discord.MessageEmbed().setTitle("ERROR | You havent setup any tiktok Channels yet!").setColor(es.wrongcolor).setDescription("Add some others first...".substr(0, 2000)).setFooter(es.footertext, es.footericon)));

          case 48:
            buffer = "";
            emojis = ["0️⃣", "5️⃣"];

            for (i = 0; i < client.social_log.get(message.guild.id, "tiktok.channels").length; i++) {
              buffer += "".concat(emojis[i], " ").concat(client.social_log.get(message.guild.id, "tiktok.channels")[i]);
            }
              ...
              return regeneratorRuntime.async(function _callee3$(_context3) {
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      channel = client.social_log.get(message.guild.id, "tiktok.channels")[emojis.findIndex(function (emoji) {
          ...
          case 64:
            ...
            for (_i2 = 0; _i2 < client.social_log.get(message.guild.id, "tiktok.channels").length; _i2++) {
              buffer += "".concat(emojis[_i2], " ").concat(client.social_log.get(message.guild.id, "tiktok.channels")[_i2]);
            }
