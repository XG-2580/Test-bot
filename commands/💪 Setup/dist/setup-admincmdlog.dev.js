      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            temptype = "";
            _context2.next = 8;
            return regeneratorRuntime.awrap(message.channel.send(new Discord.MessageEmbed().setTitle("What do you want to do?").setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setDescription("1\uFE0F\u20E3 **== `\u2714\uFE0F Enable` / Set** Channel\n        \n2\uFE0F\u20E3 **== `\u274C Disable`** Log\n\n\uD83D\uDCD1 **== Show Settings**\n\n\n\n*React with the Right Emoji according to the Right action*").setFooter(es.footertext, es.footericon)));
                  ...
                  switch (_context.prev = _context.next) {
                    ...
                    case 3:
                      ...
                      return _context.abrupt("return", message.reply({
                        embed: new Discord.MessageEmbed().setTitle("The Channel: `".concat(message.mentions.channels.filter(function (ch) {
                          return ch.guild.id == message.guild.id;
          ...
          case 32:
            ...
            return _context2.abrupt("return", message.reply({
              embed: new Discord.MessageEmbed().setTitle("Disabled the Admin logger").setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setDescription("If someone executes an Admin Command, **no** Information will be sent".substr(0, 2048)).setFooter(es.footertext, es.footericon)
            }));
          ...
          case 37:
            ...
            thesettings = client.settings.get(message.guild.id, "adminlog");
            return _context2.abrupt("return", message.reply(new Discord.MessageEmbed().setTitle("\uD83D\uDCD1 Settings of the Admin Command Log").setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setDescription("**Channel:** ".concat(thesettings == "no" ? "Not Setupped" : "<#".concat(thesettings, "> | `").concat(thesettings, "`")).substr(0, 2048)).setFooter(es.footertext, es.footericon)));
