...
*React with the Right Emoji according to the Right action*`).setFooter(es.footertext, es.footericon)
      ...
      if (temptype === "channel") {
          ...
          .then(collected => {
            ...
            if (channel) {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a833101995723194437> The Roster is now locked to: \`${channel.name}\`. It is updating automatically!`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          ...
          .then(collected => {
            ...
            if (role) {
              ...
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a833101995723194437> Added the Role: \`${role.name}\``)
          ...
          .then(collected => {
            ...
            if (role) {
              ...
              try {
                ...
                if(thedb == client.roster3) edit_msg3(client, message.guild)
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a833101995723194437> Removed the Role: \`${role.name}\``)
                  .setDescription(`It will update in less then **5 Minutes**, *If it did not update yet*`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                .setFooter(es.footertext, es.footericon)
                );
          ...
          .then(collected => {
            ...
            if (msg) {
              if(msg.toLowerCase() == "noemoji"){
                ...
                if(thedb == client.roster3) edit_msg3(client, message.guild)
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a833101995723194437> The Roster will now add ${msg} to each Listed Member!`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
              ...
              try {
                if(msg.includes(":")){
                  ...
                  if(thedb == client.roster3) edit_msg3(client, message.guild)
                  return message.reply(new Discord.MessageEmbed()
                    .setTitle(`<a833101995723194437> The Roster will now add ${msg.substr(0, 5)} to each Listed Member!`)
                    .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          ...
          .then(collected => {
            ...
            if (msg) {
              try {
                ...
                if(thedb == client.roster3) edit_msg3(client, message.guild)
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a833101995723194437> The Roster will now add ${msg.substr(0, 256)} to each Listed Member!`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                    .setDescription(`To add Roles to the Roster type: \`${prefix}setup-roster\`\n\nIt will update in less then **5 Minutes**, *If it did not update yet*`.substr(0, 2048))
                  .setFooter(es.footertext, es.footericon)
                );
        ...
        if(thedb == client.roster3) edit_msg3(client, message.guild)
        return message.reply(new Discord.MessageEmbed()
          .setTitle(`<a833101995723194437> The Roster will now ${thedb.get(message.guild.id, "inline") ? "": "__**not**__"} have multiple lines!`)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
            .setDescription(`To add Roles to the Roster type: \`${prefix}setup-roster\`\n\nIt will update in less then **5 Minutes**, *If it did not update yet*`.substr(0, 2048))
          .setFooter(es.footertext, es.footericon)
        );
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(`<a833101995723194437> The Roster will now ${thedb.get(message.guild.id, "showallroles") ? "": "__**not**__ "}cut of if there are too many Members (20+) who have the Role!`)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          .setDescription(`To add Roles to the Roster type: \`${prefix}setup-roster\`\n\nIt will update in less then **5 Minutes**, *If it did not update yet*`.substr(0, 2048))
          .setFooter(es.footertext, es.footericon)
        );
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle(`<a833101995723194437> Resetted ${rostercount} Roster!`)
          .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
