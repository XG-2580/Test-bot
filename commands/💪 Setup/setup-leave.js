          ...
          .then(async collected => {
                ...
                .then(collected => {
                  ...
                  if (channel) {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a833101995723194437> The new leave Cannel is: \`${channel.name}\``)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
            ...
            //Disable - CHANNEL
              ...
              try {
                ...
                return reaction.message.channel.send(new Discord.MessageEmbed()
                  .setTitle(`<a833101995723194437> Disabled the leave **Message**`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                ...
                .then(async collected => {
                  ...
                  if (reaction.emoji.name === "1️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a833101995723194437> I will now send no Image with the leave Message`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  ...
                  if (reaction.emoji.name === "2️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a833101995723194437> I will now send an Image with the leave Message`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  ...
                  if (reaction.emoji.name === "6️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a833101995723194437> ${client.settings.get(message.guild.id, "leave.frame") ? "Enabled the Frame for the Automated leave Image" : "Disabled the Frame for the Automated leave Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  ...
                  if (reaction.emoji.name === "7️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a833101995723194437> ${client.settings.get(message.guild.id, "leave.discriminator") ? "Enabled the Discrimantor (4 Numbers with #) for the Automated leave Image" : "Disabled the Discrimantor (4 Numbers with #) for the Automated leave Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "8️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a833101995723194437> ${client.settings.get(message.guild.id, "leave.membercount") ? "Enabled the MemberCount Text for the Automated leave Image" : "Disabled the MemberCount Text for the Automated leave Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "9️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a833101995723194437> ${client.settings.get(message.guild.id, "leave.servername") ? "Enabled Servername Text Frame for the Automated leave Image" : "Disabled the Servername Text for the Automated leave Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "🔟") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a833101995723194437> ${client.settings.get(message.guild.id, "leave.pb") ? "Enabled Profile Picture for the Automated leave Image" : "Disabled Profile Picture for the Automated leave Image"}`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
              ...
              await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
                ...
                .then(collected => {
                  ...
                  try {
                    ...
                    return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<a833101995723194437> The new leave Message is:`)
                      .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
            ...
            //Enable/Disable Invite Information - CHANNEL
              ...
              try {
                ...
                return reaction.message.channel.send(new Discord.MessageEmbed()
                  .setTitle(`<a833101995723194437> ${client.settings.get(message.guild.id, "leave.invite") ? "Enabled Invite Information" : "Disabled INvite INformation"}`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
          ...
          .then(async collected => {
            ...
            if (reaction.emoji.name === "1️⃣") {
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a833101995723194437> I will now send leave-Messages to a new User in his DMS`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
            ...
            //Disable - CHANNEL
              ...
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a833101995723194437> I will now send **NO** leave-Messages to a new User in his DMS`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
                ...
                .then(async collected => {
                  ...
                  if (reaction.emoji.name === "1️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a833101995723194437> I will now send no Image with the leave Message (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setFooter(es.footertext, es.footericon)
                      );
                    } catch (e) {
                  ...
                  if (reaction.emoji.name === "2️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a833101995723194437> I will now send an Image with the leave Message (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setFooter(es.footertext, es.footericon)
                      );
                    } catch (e) {
                  ...
                  if (reaction.emoji.name === "6️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a833101995723194437> ${client.settings.get(message.guild.id, "leave.framedm") ? "Enabled the Frame for the Automated leave Image" : "Disabled the Frame for the Automated leave Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setFooter(es.footertext, es.footericon)
                      );
                    } catch (e) {
                  ...
                  if (reaction.emoji.name === "7️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a833101995723194437> ${client.settings.get(message.guild.id, "leave.discriminatordm") ? "Enabled the Discrimantor (4 Numbers with #) for the Automated leave Image" : "Disabled the Discrimantor (4 Numbers with #) for the Automated leave Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "8️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a833101995723194437> ${client.settings.get(message.guild.id, "leave.membercountdm") ? "Enabled the MemberCount Text for the Automated leave Image" : "Disabled the MemberCount Textthe Automated leave Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "9️⃣") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a833101995723194437> ${client.settings.get(message.guild.id, "leave.servernamedm") ? "Enabled Servername Text Frame for the Automated leave Image" : "Disabled the Servername Text for the Automated leave Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
                  ...
                  if (reaction.emoji.name === "🔟") {
                    ...
                    try {
                      ...
                      return message.reply(new Discord.MessageEmbed()
                        .setTitle(`<a833101995723194437> ${client.settings.get(message.guild.id, "leave.pbdm") ? "Enabled Profile Picture for the Automated leave Image" : "Disabled Profile Picture for the Automated leave Image"} (DM)`)
                        .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                        .setDescription(`If Someone joins this Server, a message **with an automated image** will be sent into ${message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) ? message.guild.channels.cache.get(client.settings.get(message.guild.id, "leave.channel")) : "NO CHANNEL DEFINED YET"}`.substr(0, 2048))
                        .setFooter(es.footertext, es.footericon)
                      );
              ...
              await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
                ...
                .then(collected => {
                  ...
                  try {
                    ...
                    return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<a833101995723194437> The new leave Message is: (DM)`)
                      .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
            ...
            //Enable/Disable Invite Information - CHANNEL
              ...
              try {
                ...
                return reaction.message.channel.send(new Discord.MessageEmbed()
                  .setTitle(`<a833101995723194437> ${client.settings.get(message.guild.id, "leave.invitedm") ? "Enabled Invite Information" : "Disabled INvite INformation"}`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
                ...
                .then(collected => {
                  ...
                  if (role) {
                    ...
                    if (leaveroles.includes(role.id)) return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<833101993668771842> ERROR | The role: \`${role.name}\` is already registered as an leave Role`)
                      .setColor(es.wrongcolor)
                      .setFooter(es.footertext, es.footericon)
                    );
                    client.settings.push(message.guild.id, role.id, "leave.roles");
                    return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<a833101995723194437> The role: \`${role.name}\` is now registered as an leave Role`)
                      .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
              ...
              await tempmsg.channel.awaitMessages(m => m.author.id === message.author.id, {
                ...
                .then(collected => {
                  ...
                  if (role) {
                    var leaveroles = client.settings.get(message.guild.id, "leave.roles")
                    if (!leaveroles.includes(role.id)) return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<833101993668771842> ERROR | The role: \`${role.name}\` is not registered as an leave Role yet`)
                      .setColor(es.wrongcolor)
                      .setFooter(es.footertext, es.footericon)
                    );
                    client.settings.remove(message.guild.id, role.id, "leave.roles");
                    return message.reply(new Discord.MessageEmbed()
                      .setTitle(`<a833101995723194437> Remove the role: \`${role.name}\` from the leave Roles`)
                      .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                      .setDescription(`Everyone who joins will get those Roles now:\n<@&${client.settings.get(message.guild.id, "leave.roles").join(">\n<@&")}>`.substr(0, 2048))
                      .setFooter(es.footertext, es.footericon)
                    );
