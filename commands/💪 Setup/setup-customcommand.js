    ...
    try {
      ...
      try {
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle("<833101993668771842> Missing Permission to add Reactions")
      ...
      if (timeouterror)
        return message.reply(new Discord.MessageEmbed()
          .setTitle("<833101993668771842> Your Time ran out")
          .setColor(es.wrongcolor)
      ...
      if (temptype == "add") {
        if(client.customcommands.get(message.guild.id, "commands").length > 19)
          return message.reply(new Discord.MessageEmbed()
            .setTitle("<833101993668771842> You've reached the maximum Custom Commands Amount!")
            .setColor(es.wrongcolor)
          ...
          .then(collected => {
            ...
            if (reaction) {
              ...
              try {
                ...
                return message.reply(new Discord.MessageEmbed()
                  .setTitle(`<a833101995723194437> I successfully deleted \`${thecmd.name}\`!`)
                  .setColor(es.color).setThumbnail(es.thumb ? es.footericon : null)
                  .setFooter(es.footertext, es.footericon)
                );
              } catch (e) {
                return message.reply(new Discord.MessageEmbed()
                  .setTitle("<833101993668771842> Something went wrong, please contact: `XG#2846`")
                  .setColor(es.wrongcolor)
        ...
        return message.reply(new Discord.MessageEmbed()
          .setTitle("<833101993668771842> PLEASE CONTACT `XG#2846`")
          .setColor(es.wrongcolor)
          .setFooter(es.footertext, es.footericon)
        );
      }
