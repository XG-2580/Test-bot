    ...
    return regeneratorRuntime.async(function run$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            work = function _ref() {
              var owo, nekoapiclassic;
              return regeneratorRuntime.async(function work$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      _context.next = 2;
                      return regeneratorRuntime.awrap(neko.nsfw.classic());

                    case 2:
                      owo = _context.sent;
                      nekoapiclassic = new Discord.MessageEmbed().setTitle("Neko.Life API Classic Endpoint").setImage(owo.url).setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setFooter(es.footertext, es.footericon).setURL(owo.url);
