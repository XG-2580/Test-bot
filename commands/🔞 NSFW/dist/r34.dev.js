            ...
            booru.search('rule34', [query], {
              ...
              try {
                for (var _iterator = images[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                  ...
                  var embed = new Discord.MessageEmbed().setTitle("Rule34:").setImage(image.common.file_url).setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setFooter(es.footertext, es.footericon).setFooter("Tags: r34 ".concat(query)).setURL(image.common.file_url);
