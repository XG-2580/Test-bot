    ...
    try {
      ...
      if(data.weekly !== 0 && timeout - (Date.now() - data.weekly) > 0){
        ...
        return message.reply({embed: new MessageEmbed()
          ...
          .setTitle(`<833101993668771842> You've already collected your weekly reward!`)
      ...
      //YEA
        ...
        return message.reply(new MessageEmbed()
          ...
          .setFooter(message.author.tag, message.author.displayAvatarURL({dynamic: true}))
          .setTitle(`<a833101995723194437> You've collected your weekly reward of \`${nFormatter(amount)} 💸\``)
