...
module.exports = {
  ...
  run: function run(client, message, args, cmduser, text, prefix) {
    var es, user, data, flip, amount, valid_Numbers, result, win;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            flip = args[0] ? args[0].toLowerCase() : false; //Heads or Tails
            ...
            return _context.abrupt("return", message.reply(new MessageEmbed().setColor(es.wrongcolor).setFooter(es.footertext, es.footericon).setTitle("Specify the `flip-result`, it should be a number between `heads`-`tails`").setDescription("Usage: `".concat(prefix, "coinflip <roll-result> <Gamble-Amount>`\n\nExample: `").concat(prefix, "coinflip heads 100`"))));
          ...
          case 13:
            ...
            return _context.abrupt("return", message.reply(new MessageEmbed().setColor(es.wrongcolor).setFooter(es.footertext, es.footericon).setTitle("Specify the **amount of `Coins \uD83D\uDCB8`** you want to gamble!").setDescription("Usage: `".concat(prefix, "coinflip <roll-result> <Gamble-Amount>`\n\nExample: `").concat(prefix, "coinflip heads 100`"))));
