        ...
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            return _context.abrupt("return", message.channel.send(new MessageEmbed().setColor(es.wrongcolor).setFooter(user.tag, user.displayAvatarURL({
              dynamic: true
            })).setTitle("You didn't pinged to whom you want to pay").setDescription("Usage: `".concat(prefix, "removemoney <@USER> <Amount>`\n\nExample: `").concat(prefix, "removemoney <@442355791412854784> 42069`"))));
          ...
          case 10:
            ...
            return _context.abrupt("return", message.channel.send(new MessageEmbed().setColor(es.wrongcolor).setFooter(user.tag, user.displayAvatarURL({
              dynamic: true
            })).setTitle("You didn't remove the payamount").setDescription("Usage: `".concat(prefix, "removemoney <@USER> <Amount>`\n\nExample: `").concat(prefix, "removemoney <@442355791412854784> 42069`"))));
          ...
          case 16:
            ...
            return _context.abrupt("return", message.channel.send(new MessageEmbed().setColor(es.wrongcolor).setFooter(user.tag, user.displayAvatarURL({
              dynamic: true
            })).setTitle("You can't remove a negative Amount of Money or no Money, to ".concat(topay))));
          ...
          case 21:
            ...
            return _context.abrupt("return", message.channel.send(new MessageEmbed().setColor(es.wrongcolor).setFooter(user.tag, user.displayAvatarURL({
              dynamic: true
            })).setTitle("You can't remove more Money than you he has in his/her **\uD83D\uDC5B Pocket (`".concat(data2.balance, " \uD83D\uDCB8`)**"))));
          ...
          case 23:
            ...
            return _context.abrupt("return", message.reply(new MessageEmbed().setColor(es.color).setFooter(user.tag, user.displayAvatarURL({
              dynamic: true
            })).setTitle("**You removeed `".concat(payamount, " \uD83D\uDCB8` to `").concat(topay.tag, "`**")).setDescription("\uD83D\uDC5B **".concat(topay.username, "** now has `").concat(Math.floor(data2.balance), " \uD83D\uDCB8` in his/her Pocket"))));
