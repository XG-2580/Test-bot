      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 26:
            ...
            _context.next = 29;
            return regeneratorRuntime.awrap(canvacord.Canvas.rainbow(avatar));

          case 29:
            image = _context.sent;
            _context.next = 32;
            return regeneratorRuntime.awrap(new MessageAttachment(image, "rainbow.png"));

          case 32:
            attachment = _context.sent;
            message.channel.send(new MessageEmbed().setColor(es.color).setThumbnail(es.thumb ? es.footericon : null).setFooter(es.footertext, es.footericon).setImage("attachment://rainbow.png").attachFiles(attachment))["catch"](function (e) {
