      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 16:
            ...
            user = alluser.find(function (u) {
              return u.includes(args[0].toLowerCase());
            });
          ...
          case 25:
            ...
            client.memer.jail(avatar).then(function (image) {
              //make an attachment
              var attachment = new MessageAttachment(image, "jail.png"); //delete old message

              tempmsg["delete"](); //send new Message

              message.channel.send(tempmsg.embeds[0].setAuthor("Meme for: ".concat(user.tag), avatar).setImage("attachment://jail.png").attachFiles(attachment))["catch"](function (e) {
