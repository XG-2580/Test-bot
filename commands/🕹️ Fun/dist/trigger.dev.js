      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 25:
            ...
            canvacord.Canvas.trigger(avatar).then(function (image) {
              //make an attachment
              var attachment = new MessageAttachment(image, "triggered.gif"); //delete old message

              tempmsg["delete"](); //send new Message

              message.channel.send(tempmsg.embeds[0].setAuthor("Meme for: ".concat(user.tag), avatar).setImage("attachment://triggered.gif").attachFiles(attachment))["catch"](function (e) {
