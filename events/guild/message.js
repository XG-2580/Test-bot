...
const ee = require("../../base-system/embed.json"); //Loading all embed settings like color footertext and icon ...
        ...
        if(disablecmds.some(i => String(command.name).toLowerCase().includes(i.toLowerCase())) || 
          ...
          if(require('path').resolve(__dirname).split("/")[3].includes("FREEBOT_")){
            ...
            return message.channel.send(new MessageEmbed()
              ...
              .setTitle(`**THIS COMMAND IS PREMIUM ONLY** <a:nitro:833402717506502707>`)
              .setDescription(`This means, you need to **pay** in Order to be able to use this Command!\n\n[Website](https://Limsathya) - [Pay through here](https://discord.gg/FQGXbypRf8)`)
            );
          }
        }
